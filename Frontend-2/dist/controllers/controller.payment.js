...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } //Importa las constantes 'HOST' y 'PAYPAL_API' desde el modulo ./config/config.js
        ...
        case 0:
          ...
          order = {
            ...
            purchase_units: [{
              amount: {
                currency_code: "USD",
                //Codigo de moneda en dolares estadounidenses
                value: "100.00" //Valor del monto de la orden, es este caso $100.00
              }
            }],
            application_context: {
              brand_name: "Travels Wings",
              // Nombre del servicio
              landing_page: "NO_PREFERENCE",
              // Pagina de destino preferida
              user_action: "PAY_NOW",
              // Accion del usuario para pagar ahora
              return_url: "".concat(_config.HOST, "/capture-order"),
              //url de retorno despues de la captura de la orden
              cancel_url: "".concat(_config.HOST, "/cancel-order") //url de cancelacion de pago
            }
          }; //FinalObjeto
          ...
          return _axios["default"].post("".concat(_config.PAYPAL_API, "/v1/oauth2/token"), params, {
            auth: {
              ...
              //Nombre de usuario para la autentificacion
              password: _config.PAYPAL_API_SECRET //contraseña para autentificacion
            }
          });
        case 5:
          ...
          return _axios["default"].post("".concat(_config.PAYPAL_API, "/v2/checkout/orders"), order, {
            headers: {
              Authorization: "Bearer ".concat(access_token) //Agrega el token de acceso en los encabezados de autorizacion
            }
          });
        case 9:
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          //inicio funcion
          token = req.query.token; //Realiza una solicitud POST a la API de paypal para capturar una orden utilizando el token proporcionado.
          _context2.next = 3;
        ...
        case 3:
          ...
          return _context2.abrupt("return", res.send('Payed'));
        case 6:
        case "end":
